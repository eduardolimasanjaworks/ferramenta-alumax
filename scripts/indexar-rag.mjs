 ...
 * e envia (upsert) para a coleção `tilit_conhecimento` no Qdrant.
 *
 * Uso:
 ...
 *   QDRANT_URL       -> padrao http://127.0.0.1:6341 (host) — dentro do compose use http://qdrant:6333
 */
...
const QDRANT_URL = process.env.QDRANT_URL_HOST || process.env.QDRANT_URL || 'http://127.0.0.1:6341';
const COLECAO = 'tilit_conhecimento';
